...
const PROJECTS = [
  {
    ...
    beforeAlt:
      'Bare concrete entry steps with glass railings before epoxy flake coating',
    afterAlt:
      'Entry steps with glass railings finished in grey speckled epoxy flake coating',
  },
  {
  ...
  },
  {
    ...
    beforeAlt:
      'Uncoated concrete entry steps and landing before epoxy flake coating',
    afterAlt:
      'Entry steps and landing finished with grey speckled epoxy flake coating',
  },
  {
  ...
  },
  {
    ...
    beforeAlt:
      'Exterior steps and patio protected during epoxy coating preparation',
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center">
          <div className="flex items-center justify-center gap-2.5">
            ...
            <span className="text-xs font-semibold tracking-[3px] text-gold">
              OUR WORK
            </span>
            <div className="w-[30px] h-0.5 bg-gold" />
          </div>
